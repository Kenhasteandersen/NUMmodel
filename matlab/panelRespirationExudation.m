...
switch p.nameGroup{iGroup}
    case 'Generalists'
        ...
        betaL = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'bL');
        betaN = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'bN');
        betaDOC = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'bDOC');
        betaF = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'bF');
        betaG = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'bg');
        eL = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'epsilonL');
        eF = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'epsilonF');
    ...
    case 'Diatoms'
        ...
        betaN = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'bN');
        betaDOC = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'bDOC');
        betaSi = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'bSi');
        betaG = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'bg');
        eL = search_namelist('../input/input.yaml', p.nameGroup{iGroup}, 'epsilonL');
