...
%
% Other warning: plots for global simulation is not coded for the moment...
%
% In:
...
if strcmp(sim.p.nameModel,'chemostat') || strcmp(sim.p.nameModel,'watercolumn')
    ...
    if strcmp(sim.p.nameModel, 'watercolumn')
        ...
        sgtitle('Nitrogen, DOC & DIC fluxes ({\mu}gC/l/day) from POM/ Total biomass of POM ({\mu}gC/l)')
    end
