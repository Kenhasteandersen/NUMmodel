...
%  bMulticellularOnly - Have the mortality only affecting multicellular plankton (but still
%                  with the size selectivity)
%
% Out:
%  Nothing; the function only affects the fortran library.
%
function setHTL(mortHTL, mHTL, bQuadraticHTL, bDecliningHTL, bMulticellularOnly)
