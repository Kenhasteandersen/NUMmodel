...
sim5000calF=simGlobalFull_fun;

Bdep=squeeze(sum(sim5000calF.B,3));
BdepSize=squeeze(sum(Bdep,3));
%%
figure(55)
clf(55)
subplot(1,3,1)
...
subplot(1,3,3)
surface(log10(Chl_a)'); shading flat; colorbar; title("Annual average Chl-a (mgCm^{-3})")
caxis([-1.7 1.7]);
axis tight
