...
function Sensitivity_sinkingPOM(lat_to_find,lon_to_find,name_png,NPP_extracted,noYears)
...
newParameter=newSinkingPOM;
param_str='sinkingPOM';
...
for  iparam = 1:length(newParameter)
        ...
        setSinkingPOM(p, newParameter(iparam))
        p.tEnd = runningTime;
