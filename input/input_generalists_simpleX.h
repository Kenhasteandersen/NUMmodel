...
!***********************************************************************
!
  mMinGeneralist = 3*1.1623d-9  ! Smallest cell size [mug C]
  mMaxGeneralist = 3*1.0d0	! Largest cell size [mug C]

! Light uptake:
!--------------
  epsilonL = 3*0.8d0        ! Light uptake efficiency []
  alphaL = 3*0.3d0              ! Light affinity coef. [1/(uE/m2/s) 1/day um]
  rLstar = 3*7.5d0          ! Light affinity cross-over size [um]

! Dissolved nutrient and DOC uptake:
!-----------------------------------
  alphaN = 3*0.972d0             ! Diffusive affinity coefficient [L/d/mugC/um^2] 
  rNstar = 3*0.4d0           ! Diffusive affinity cross-over size [um]

! Phagotrophy:
!-------------
  epsilonF = 3*0.8d0	           ! Food assimilation efficiency [-]
  alphaF = 3*0.018d0             ! Clearance rate [L/d/ug C]
  cF = 3*30.0d0                     ! Max phagotrophy coefficient [um/day]
  beta = 3*500.d0                ! Preferred predator-prey mass ratio
  sigma = 3*1.3d0                ! Preferred predator-prey mass range

! Metabolism:
!------------
  cLeakage = 3*0.03d0           ! Passive leakage of C and N
  delta = 3*0.05d0                ! Thickness of cell wall [um]
  alphaJ = 3*1.5d0                ! Constant for jMax [day-1]
  cR = 3*0.1d0                   ! Basal metabolism relative to jMax [-]

! Biogeo:
!--------
  remin2 = 3*0.5d0               ! Fraction of viral lysis remineralized to DOC
  reminF = 3*0.1d0               ! Fraction of feeding losses remineralized
